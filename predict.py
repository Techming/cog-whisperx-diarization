...
class Predictor(BasePredictor):
    def setup(self):
        ...
        self.hf_access_token = "REPLACE_WITH_YOUR_HUGGING_FACE_TOKEN"
        self.device = "cuda"
        ...
        self.diarize_model = whisperx.DiarizationPipeline(
            use_auth_token=self.hf_access_token, device=self.device
        )
    ...
    def predict(
        ...
        diarization: bool = Input(
            description="Use if you want to distinguish between different speakers",
            default=False,
        ),
